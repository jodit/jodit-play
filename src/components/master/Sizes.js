			...
			<>
				<fieldset>
					...
					{this.props.state.height === 'auto' || (
						<CheckBox
							...
							checked={this.props.state.allowResizeY}
					...
					<CheckBox
						...
						checked={this.props.state.height === 'auto'}
						label="Auto height"
					/>
					...
					{this.props.state.width === 'auto' || (
						<CheckBox
							...
							name="allowResizeX"
							onChange={this.props.setOption}
							checked={this.props.state.allowResizeX}
					...
					<CheckBox
						...
						checked={this.props.state.width === 'auto'}
						label="Auto width"
					/>
					<Number
						label="Min width(px)"
				...
				<fieldset>
					...
					<List
						...
						value={this.props.state.defaultFontSizePoints}
						onChange={this.props.setOption}
						list={{
							pt: 'Points',
							px: 'Pixels'
